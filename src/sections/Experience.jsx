...
const workExperience = [
    {
        ...
        company: "Darden School of Business, UVA",
        description: [
    ...
    },
    {
        ...
        description: [
            "Developed Full Stack PHP services in Laravel and CodeIgniter for high-profile clients, focusing on client satisfaction.",
            "Built an AI-powered business-card processing system that removed 100% of manual data entry and is now used in production.",
            "Collaborated with frontend and infrastructure teams to deliver scalable features, ensuring fault tolerance and high availability."
        ],
    },
    {
        period: "2023",
        ...
        description: [
            "Built full-stack forensic dashboards using React and Flask, supporting blockchain investigations on systems processing transaction of $20M+ in cryptocurrency network.",
        ...
        <div className="px-6 md:px-12 max-w-7xl mx-auto space-y-24">
            ...
            <div>
                <div className="border-b border-zinc-800 pb-8 mb-12">
                    <h2 className="text-sm font-mono text-zinc-500 uppercase tracking-widest">02 / Professional Experience</h2>
                </div>
                    ...
                    {workExperience.map((item, idx) => (
                        ...
                        >
                            <div className="md:col-span-1">
                                <span className="text-zinc-500 font-mono text-sm block mb-1">{item.period}</span>
                            </div>

                            <div className="md:col-span-3 space-y-4">
                                <div>
                                    <h3 className="text-2xl font-semibold text-zinc-100 group-hover:text-white transition-colors">{item.role}</h3>
                                    <h4 className="text-lg text-zinc-400">{item.company}</h4>
                                </div>
                                <ul className="space-y-2">
                                    {item.description.map((desc, i) => (
                                        <li key={i} className="text-zinc-500 leading-relaxed max-w-3xl flex gap-3">
            ...
            <div>
                <div className="border-b border-zinc-800 pb-8 mb-12">
                    <h2 className="text-sm font-mono text-zinc-500 uppercase tracking-widest">03 / Research & Patents</h2>
                </div>
                    ...
                    {research.map((item, idx) => (
                        ...
                        >
                            ...
                            <div className="md:col-span-3 space-y-2">
                                <h3 className="text-2xl font-semibold text-zinc-100 group-hover:text-white transition-colors">{item.role}</h3>
                                <h4 className="text-lg text-zinc-400">{item.company}</h4>
                                <p className="text-zinc-500 leading-relaxed max-w-2xl text-sm mb-4">{item.description}</p>
                                ...
                                {item.link && (
                                    <a
                                        ...
                                        className="inline-flex items-center gap-2 text-sm text-zinc-400 hover:text-white transition-colors border-b border-zinc-700 hover:border-white pb-0.5"
                                    >
