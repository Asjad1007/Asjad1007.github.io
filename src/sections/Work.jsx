...
const projects = [
    {
        ...
        description: "An AI agent that ingests company data, ranks leads, and generates personalized emails using a 30Bparameter LLM.",
    ...
    },
    {
        ...
        tech: "Tesseract • Python • Flask • Regex • WhatsApp API",
        img: ocr,
        link: null,
    },
];
                        ...
                        <div className={`order-2 ${idx % 2 === 0 ? "lg:order-1" : "lg:order-2"}`}>
                            ...
                            >
                                <img
                                    src={project.img}
                                    alt={project.title}
                                    className="w-full aspect-[4/3] object-cover grayscale transition-all duration-700 group-hover:grayscale-0 group-hover:scale-105"
                                />
                        ...
                        <div className={`order-1 ${idx % 2 === 0 ? "lg:order-2" : "lg:order-1"} space-y-6`}>
                            ...
                            {project.link && (
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 text-white border-b border-white pb-1 hover:text-zinc-300 hover:border-zinc-300 transition-colors"
                                >
